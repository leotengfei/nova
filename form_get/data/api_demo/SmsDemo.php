...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIwdqRIjJT0ejn"; // AccessKeyId

        $accessKeySecret = "zj0lBDsJ1EOBpjspW3W0PzXFiYzFIJ"; // AccessKeySecret
...
@$utel=$_REQUEST['utel'] or die('{"code":"-2","msg":"电话号码是必须的！"}');
$msg_code=rand(0,9).rand(0,9).rand(0,9).rand(0,9);
$response = SmsDemo::sendSms(
    "无线星空", // 短信签名
    "SMS_110395049", // 短信模板编号
    $utel, // 短信接收者
    Array(  // 短信模板中字段的值
        "code"=>$msg_code
    ),
