...
(function($){
  ...
  //  		var wz = document.getElementsByTagName("video")[7];
    	...
    	$("#yydakai").click(function(){
        	$("#shipin").fadeIn(600);
        	$("#yy").fadeIn(100);
        	document.getElementById("yy").innerHTML = "<video src=\"http://owvvfr97r.bkt.clouddn.com/2018mkyy.mp4\" controls=\"controls\">你的浏览器太老了，连视频都放不了</video>";
        	$('#yy>video').get(0).play(); 
    	});
    	/*英语视频窗口显示结束*/
    	...
    	$("#sxldakai").click(function(){
        	$("#shipin").fadeIn(600);
        	$("#sxl").fadeIn(100);
        	document.getElementById("sxl").innerHTML = "<video src=\"http://owvvfr97r.bkt.clouddn.com/2018mksxl.mp4\" controls=\"controls\">你的浏览器太老了，连视频都放不了</video>";
    	...
    	$("#ywdakai").click(function(){
        	$("#shipin").fadeIn(600);
        	$("#yw").fadeIn(100);
        	document.getElementById("yw").innerHTML = "<video src=\"http://owvvfr97r.bkt.clouddn.com/2018mkyw.mp4\" controls=\"controls\">你的浏览器太老了，连视频都放不了</video>";
        	$('#yw>video').get(0).play(); 
    	});
    	$("#wldakai").click(function(){
        	$("#shipin").fadeIn(600);
        	$("#wl").fadeIn(100);
        	document.getElementById("wl").innerHTML = "<video src=\"http://owvvfr97r.bkt.clouddn.com/2018mkwl.mp4\" controls=\"controls\">你的浏览器太老了，连视频都放不了</video>";
        	$('#wl>video').get(0).play(); 
    	});
    	$("#hxdakai").click(function(){
        	$("#shipin").fadeIn(600);
        	$("#hx").fadeIn(100);
        	document.getElementById("hx").innerHTML = "<video src=\"http://owvvfr97r.bkt.clouddn.com/2018mkhx.mp4\" controls=\"controls\">你的浏览器太老了，连视频都放不了</video>";
        	$('#hx>video').get(0).play(); 
    	});
